...
@Table(name = "media")
@Builder
public class MediaEntity extends AbstractAuditEntity {
    ...
    @ManyToMany(mappedBy = "media", cascade = {CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH})
