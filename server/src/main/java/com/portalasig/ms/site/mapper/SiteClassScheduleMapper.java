 ...
 * <p>It uses {@link SitePartyMapper} for nested user mapping if necessary.</p>
 */
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING, uses = {SitePartyMapper.class})
