...
/**
 * Represents a student involved in a site, such as a professor or assistant,
...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "site_student")
@Builder
public class SiteStudentEntity extends AbstractAuditEntity {
